...
_BASE: Dict[str, Dict[str, str]] = {
    ...
    "config_error": {
        ...
        "fr": "Erreur de configuration. Vérifiez les paramètres Vikunja et OpenAI.",
        "es": "Error de configuración. Verifica la configuración de Vikunja y OpenAI.",
        "pt": "Erro de configuração. Verifique as configurações do Vikunja e OpenAI.",
        "ru": "Ошибка конфигурации. Проверьте настройки Vikunja и OpenAI.",
        "hi": "कॉन्फ़िगरेशन त्रुटि। Vikunja और OpenAI सेटिंग्स जाँचें।",
        "zh-Hans": "配置错误。请检查 Vikunja 和 OpenAI 设置。",
    ...
    "openai_conn_error": {
        ...
        "fr": "Désolé, impossible de traiter la tâche à cause d'une erreur de connexion. Réessayez plus tard.",
        "es": "No se pudo procesar la tarea por un error de conexión. Inténtalo más tarde.",
        "pt": "Não foi possível processar a tarefa devido a erro de conexão. Tente novamente mais tarde.",
        "ru": "Не удалось обработать задачу из-за ошибки подключения. Попробуйте позже.",
        "hi": "कनेक्शन त्रुटि के कारण कार्य संसाधित नहीं हो सका। बाद में पुनः प्रयास करें।",
        "zh-Hans": "由于连接错误，无法处理您的任务。请稍后再试。",
